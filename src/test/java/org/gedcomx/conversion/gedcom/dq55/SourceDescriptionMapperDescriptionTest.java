...
public class SourceDescriptionMapperDescriptionTest {
  ...
  public void testToSourceDescription1() throws Exception {
    ...
    assertEquals(gedxSourceDescription.getCitation().getCitationTemplate().getResource().toString(), "gedcom5:source-template");
    assertNotNull(gedxSourceDescription.getCitation().getFields());
    assertEquals(gedxSourceDescription.getCitation().getFields().size(), 4);
    assertEquals(gedxSourceDescription.getCitation().getFields().get(0).getName().toURI().toString(), "gedcom5:source-template/author");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(0).getValue(), "Brugge (West Vlaanderen). Burgerlijke Stand");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(1).getName().toURI().toString(), "gedcom5:source-template/title");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(1).getValue(), "Registers van de Burgerlijke Stand, 1796-1900");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(2).getName().toURI().toString(), "gedcom5:source-template/publication-facts");
    ...
    assertEquals(gedxSourceDescription.getCitation().getFields().get(3).getName().toURI().toString(), "gedcom5:source-template/call-number");
...
//        "Civil registration of births, marriages and deaths of Brugge, West Flanders, Belgium. Includes marriage proclamations, indexes, and supplements. Text in French before 1815.");
  ...
  public void testToSourceDescription2() throws Exception {
    ...
    assertEquals(gedxSourceDescription.getCitation().getFields().get(0).getName().toURI().toString(), "gedcom5:source-template/call-number");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(0).getValue(), "__callno__");
    assertEquals(gedxSourceDescription.getCitation().getFields().get(1).getName().toURI().toString(), "gedcom5:source-template/call-number");
  ...
  public void testToSourceDescription4() throws Exception {
    ...
    assertEquals(gedxSourceDescription.getCitation().getFields().get(0).getName().toURI().toString(), "gedcom5:source-template/title");
